...
// Mapping of token symbols to their respective icons
...
// The public key of the BARK program
export const PROGRAM_ID = new PublicKey('BARKkeAwhTuFzcLHX4DjotRsmjXQ1MshGrZbn1CUQqMo');

// Interface Definition Language (IDL) for the BARK Blink program
export const IDL = {
  version: "0.1.0",
  name: "bark_blink",
  instructions: [
...
// Icon color and title icon URL for UI elements
